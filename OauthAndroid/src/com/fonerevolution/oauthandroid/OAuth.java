package com.fonerevolution.oauthandroid;
...
public class OAuth {
	 ...
	 */
	public void popup (String provider, OAuthCallback callback, boolean desktop)
	{
		JSONObject opts = new JSONObject();
		this.popup(provider,  opts, callback, desktop);
	}
	...
	{
		JSONObject opts = new JSONObject();
		this.popup(provider,  opts, callback, false);
	}
	 ...
	 * @param callback An OAuthCallback implementing onFinished
	 */
	public void popup (String provider, JSONObject opts, OAuthCallback callback, boolean desktop)
	{
		if (_key == "") {
		...
		OAuthDialog dial = new OAuthDialog(mContext, this, url, desktop);
